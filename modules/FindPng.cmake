...
if(NOT TARGET Png)
  find_library(PNG_LIBRARIES NAMES png png16 libpng16)
  if(MSVC)
  ...
  if(MSVC)
    set_target_properties(Png PROPERTIES IMPORTED_LOCATION_RELEASE ${PNG_LIBRARIES})
    set_target_properties(Png PROPERTIES IMPORTED_LOCATION_DEBUG ${PNG_LIBRARIES_DEBUG})
  else()
    set_target_properties(Png PROPERTIES IMPORTED_LOCATION ${PNG_LIBRARIES})
  endif()
endif()

if(MSVC)
  find_package_handle_standard_args(Png DEFAULT_MSG PNG_LIBRARIES PNG_LIBRARIES_DEBUG PNG_INCLUDE_DIR)
else()
