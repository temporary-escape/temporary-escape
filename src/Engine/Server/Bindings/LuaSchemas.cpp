...
template <typename T> struct BindSchemaHelper {
    template <typename C>
    static void bind(sol::table& m, sol::usertype<C>& klass, const std::string& field, const std::string& name) {
...
static void bindSchemas(sol::table& m) {
    {
        /**
         * @class GalaxyData
...

    {
         ...
         * @readonly
         */
        BindSchemaHelper<GalaxyData>::bind(m, cls, "galaxies", "GalaxyData");
        /**
         * @field Database.regions
         * @type Repository<RegionData>
         * @readonly
         */
        BindSchemaHelper<RegionData>::bind(m, cls, "regions", "RegionData");
        /**
         * @field Database.factions
         * @type Repository<FactionData>
         * @readonly
         */
        BindSchemaHelper<FactionData>::bind(m, cls, "factions", "FactionData");
        /**
         * @field Database.systems
         * @type Repository<SystemData>
         * @readonly
         */
        BindSchemaHelper<SystemData>::bind(m, cls, "systems", "SystemData");
        /**
         * @field Database.sectors
         * @type Repository<SectorData>
         * @readonly
         */
        BindSchemaHelper<SectorData>::bind(m, cls, "sectors", "SectorData");
        /**
         * @field Database.planets
         * @type Repository<PlanetData>
         * @readonly
         */
        BindSchemaHelper<PlanetData>::bind(m, cls, "planets", "PlanetData");
        /**
         * @field Database.players
         * @type Repository<PlayerData>
         * @readonly
         */
        BindSchemaHelper<PlayerData>::bind(m, cls, "players", "PlayerData");
        /**
         * @field Database.player_locations
         * @type Repository<PlayerLocationData>
         * @readonly
         */
        BindSchemaHelper<PlayerLocationData>::bind(m, cls, "player_locations", "PlayerLocationData");
        /**
         * @field Database.metadata
         * @type Repository<MetaData>
         * @readonly
         */
        BindSchemaHelper<MetaData>::bind(m, cls, "metadata", "MetaData");
        BindSchemaHelper<StartingLocationData>::bind(m, cls, "starting_locations", "StartingLocationData");
    }
}

LUA_BINDINGS(bindSchemas);
