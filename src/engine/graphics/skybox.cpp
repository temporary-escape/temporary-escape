...
Skybox::Skybox(VulkanRenderer& vulkan, const Color4& color) {
    ...
    vulkan.transitionImageLayout(irradiance, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                                 VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    vulkan.transitionImageLayout(prefilter, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                                 VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
}
