#include "render_pass_bloom_downsample.hpp"
#include "../../assets/assets_manager.hpp"
#include "../../scene/scene.hpp"

using namespace Engine;

RenderPassBloomDownsample::RenderPassBloomDownsample(VulkanRenderer& vulkan, RenderBufferPbr& buffer,
                                                     RenderResources& resources, AssetsManager& assetsManager,
                                                     const uint32_t level) :
    RenderPass{vulkan, buffer, "RenderPassBloomDownsample"},
    buffer{buffer},
    resources{resources},
    pipelineBloomDownsample{vulkan, assetsManager},
    level{level} {
