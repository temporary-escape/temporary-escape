...
public:
    ...
    public:
        ...
        explicit Downsample(VulkanRenderer& vulkan, Registry& registry, const Vector2i& viewport,
    ...
    public:
        ...
        explicit Extract(VulkanRenderer& vulkan, Registry& registry, const Vector2i& viewport,
                         const VulkanTexture& forward);
    ...
    public:
        ...
        explicit Blur(VulkanRenderer& vulkan, Registry& registry, const Vector2i& viewport, const VulkanTexture& dst,
    ...
    explicit RenderPassBloom(VulkanRenderer& vulkan, Registry& registry, const Vector2i& viewport,
                             const VulkanTexture& forward);
