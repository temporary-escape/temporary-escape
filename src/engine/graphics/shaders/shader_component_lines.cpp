#include "shader_component_lines.hpp"

using namespace Engine;

ShaderComponentLines::ShaderComponentLines(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("component-lines.vert");
    auto& frag = modules.findByName("component-lines.frag");
