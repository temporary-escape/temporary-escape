#include "shader_pass_fxaa.hpp"

using namespace Engine;

ShaderPassFXAA::ShaderPassFXAA(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("pass-fxaa.vert");
    auto& frag = modules.findByName("pass-fxaa.frag");
