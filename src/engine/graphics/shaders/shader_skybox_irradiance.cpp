#include "shader_skybox_irradiance.hpp"

using namespace Engine;

ShaderSkyboxIrradiance::ShaderSkyboxIrradiance(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("skybox-irradiance.vert");
    auto& frag = modules.findByName("skybox-irradiance.frag");
