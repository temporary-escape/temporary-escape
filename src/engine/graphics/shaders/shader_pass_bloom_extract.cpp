#include "shader_pass_bloom_extract.hpp"

using namespace Engine;

ShaderPassBloomExtract::ShaderPassBloomExtract(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    descriptorSetLayout = vulkan.createDescriptorSetLayout({textureLayoutBinding});

    auto& vert = modules.findByName("pass-bloom-extract.vert");
    auto& frag = modules.findByName("pass-bloom-extract.frag");
