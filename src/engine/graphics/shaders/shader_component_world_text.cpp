#include "shader_component_world_text.hpp"

using namespace Engine;

ShaderComponentWorldText::ShaderComponentWorldText(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("component-world-text.vert");
    auto& geom = modules.findByName("component-world-text.geom");
    auto& frag = modules.findByName("component-world-text.frag");

    VulkanPipeline::CreateInfo pipelineInfo{};
    pipelineInfo.shaderModules = {&vert, &geom, &frag};
    ...
    attributeDescriptions[1].offset = offsetof(Vertex, offset);
