#include "shader_skybox_stars.hpp"

using namespace Engine;

ShaderSkyboxStars::ShaderSkyboxStars(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("skybox-stars.vert");
    auto& frag = modules.findByName("skybox-stars.frag");
    auto& geom = modules.findByName("skybox-stars.geom");
    ...
    attributeDescriptions[1].offset = offsetof(Vertex, brightness);
