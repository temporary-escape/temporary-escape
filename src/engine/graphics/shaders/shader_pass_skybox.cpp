#include "shader_pass_skybox.hpp"

using namespace Engine;

ShaderPassSkybox::ShaderPassSkybox(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("pass-skybox.vert");
    auto& frag = modules.findByName("pass-skybox.frag");
