#include "shader_skybox_nebula.hpp"

using namespace Engine;

ShaderSkyboxNebula::ShaderSkyboxNebula(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("skybox-nebula.vert");
    auto& frag = modules.findByName("skybox-nebula.frag");
