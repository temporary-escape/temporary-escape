#include "shader_component_2d_shape.hpp"

using namespace Engine;

ShaderComponent2DShape::ShaderComponent2DShape(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("component-2d-shape.vert");
    auto& frag = modules.findByName("component-2d-shape.frag");
    ...
    pipelineInfo.inputAssembly.primitiveRestartEnable = VK_TRUE;
