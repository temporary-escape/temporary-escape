#include "shader_pass_flare.hpp"

using namespace Engine;

ShaderPassFlare::ShaderPassFlare(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("pass-flare.vert");
    auto& frag = modules.findByName("pass-flare.frag");
    auto& geom = modules.findByName("pass-flare.geom");
