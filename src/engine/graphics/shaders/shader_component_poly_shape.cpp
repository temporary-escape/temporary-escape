#include "shader_component_poly_shape.hpp"

using namespace Engine;

ShaderComponentPolyShape::ShaderComponentPolyShape(const Config& config, VulkanRenderer& vulkan, ShaderModules& modules,
    ...
    auto& vert = modules.findByName("component-poly-shape.vert");
    auto& frag = modules.findByName("component-poly-shape.frag");
