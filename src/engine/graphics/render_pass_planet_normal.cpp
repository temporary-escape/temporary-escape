...
RenderPassPlanetNormal::RenderPassPlanetNormal(VulkanRenderer& vulkan, Registry& registry, const Vector2i& viewport) :
    RenderPass{vulkan, viewport}, subpassPlanetNormal{vulkan, registry} {
