...
RenderPassForward::RenderPassForward(VulkanRenderer& vulkan, Registry& registry, const Vector2i& viewport,
    ...
    // Depth
    addAttachment(opaque.getTexture(RenderPassOpaque::Depth), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                  VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_ATTACHMENT_LOAD_OP_LOAD);
    // Forward
    addAttachment(lighting.getTexture(RenderPassLighting::Forward), VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
                  VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_ATTACHMENT_LOAD_OP_LOAD);
