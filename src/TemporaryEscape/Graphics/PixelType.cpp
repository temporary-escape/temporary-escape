...
GLenum Engine::toTextureFormat(const PixelType type) {
    switch (type) {
...
GLenum Engine::toTextureInternalFormat(const PixelType type) {
    switch (type) {
    case PixelType::Red8u: {
        return GL_R8;
    }
...
GLenum Engine::toTextureType(const PixelType type) {
    switch (type) {
    case PixelType::Red8u:
    case PixelType::Rg8u:
    case PixelType::Rgb8u:
