...
ENGINE_API GLenum toTextureFormat(PixelType type);
ENGINE_API GLenum toTextureInternalFormat(PixelType type);
ENGINE_API GLenum toTextureType(PixelType type);
} // namespace Engine
