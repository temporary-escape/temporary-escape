...
#include "../../Common/Conditions.hpp"
#include "../../Common/IoServiceRunner.hpp"
#include <Engine/Network/NetworkMessage.hpp>
#include <Engine/Network/NetworkTcpClient.hpp>
#include <Engine/Network/NetworkTcpServer.hpp>
#include <Engine/Utils/Worker.hpp>
#include <thread>
...
public:
    CustomServer() : NetworkTcpServer(*this, 1) {
    }
